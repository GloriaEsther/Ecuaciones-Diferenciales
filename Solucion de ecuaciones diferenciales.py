...
#agregar_funcion1.place(x=255, y=80)#aqui
########################  Variable independiente(simbolica)  #############################
agregar_funcion1 = tkinter.Entry(ventana, text="Agregue la variable deseada ", bg="#3F33FF",
                                 width="20", font="helvetica 15")
agregar_funcion1.place(x=14, y=80)#aqui
...
# Funcion ######################################
agregar_funcion1 = tkinter.Entry(ventana,text="Agregue funcion ",bg="#3F33FF",
                                 width="20", font="helvetica 15")
agregar_funcion1.place(x=14, y=130)
